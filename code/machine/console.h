...
class ConsoleInput_ : public CallBackObj {
  public:
    ConsoleInput_(char *readFile, CallBackObj *toCall);
				// initialize hardware console input 
    ~ConsoleInput_();		// clean up console emulation
...
class ConsoleOutput_ : public CallBackObj {
  public:
    ConsoleOutput_(char *writeFile, CallBackObj *toCall);
				// initialize hardware console output 
    ~ConsoleOutput_();		// clean up console emulation
